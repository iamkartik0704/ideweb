          ...
          <div className="download-grid">
            ...
            <div className="download-card">
              ...
              <div className="download-card-links">
                <a 
  href="https://github.com/iamkartik0704/compile/releases/download/v1.1.14/compile-1.1.14-win-x64.exe" 
...
>
  .exe <span className="download-tag">Installer</span>
            ...
            <div className="download-card">
              ...
              <div className="download-card-links">
                <a href="https://github.com/iamkartik0704/compile/releases/download/v1.1.14/compile-1.1.14-mac-arm64.zip" className="download-link">
                  .zip <span className="download-tag">Apple Silicon (M Series)</span>
                </a>
                <a href="https://github.com/iamkartik0704/compile/releases/download/v1.1.14/compile-1.1.14-mac-x64.zip" className="download-link" style={{ marginTop: '8px' }}>
